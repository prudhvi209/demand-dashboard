    ...
    >
      <div className="glass-panel rounded-3xl p-8 border border-white/70 shadow-xl space-y-8 relative overflow-hidden">
        ...
        <div className="pt-2">
          <button
            onClick={logout}
            className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-rose-50 hover:bg-rose-100 text-rose-600 text-xs font-semibold transition border border-rose-200/60"
          >
