    ...
    return (
      <div className="glass-panel p-3 rounded-xl shadow-lg border border-white/80 text-xs">
        ...
        <div className="flex items-center gap-2 text-blue-600 font-medium">
          ...
          <span>Open Demand: {payload[0].value} positions</span>
        </div>
        {payload[1] && (
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium mt-0.5">Monthly trajectory of open talent requests</p>
        </div>
        {hasData && (
          <div className="flex items-center gap-4 text-xs font-medium">
            <div className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-blue-600" />
              <span className="text-slate-600">Open Demand</span>
            </div>
            <div className="flex items-center gap-1.5">
