...
import { IntVsExtDistributionData } from '../../types';
...
export const IntVsExtPieChart: React.FC<IntVsExtPieChartProps> = ({ data = [], snapshotWeek }) => {
    ...
    >
      <div>
        ...
        <p className="text-xs text-slate-500 font-medium mt-0.5">
          Headcount required by resource type{snapshotWeek ? ` · ${snapshotWeek}` : ''}
        </p>
      </div>
